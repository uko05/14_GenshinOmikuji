...
export const horoscope = {
  aries: {
    ...
    luckyColor: ['赤', 'コーラルピンク', 'オレンジ', 'ホワイト', 'ゴールド', 'スカーレット', 'テラコッタ', 'ブライトレッド'],
    luckyColor_en: ['Red', 'Coral pink', 'Orange', 'White', 'Gold', 'Scarlet', 'Terra cotta', 'Bright red'],
    luckyItem: ['カラーリップ', 'スポーツウェア', 'ネイル', '赤いアクセサリー', 'ヘアアクセ', 'マスカラ', 'エナジードリンク', '新しいノート'],
    luckyItem_en: ['Colored lip', 'Sportswear', 'Nail color', 'Red accessory', 'Hair accessory', 'Mascara', 'Energy drink', 'New notebook'],
    luckyNumber: [1, 9, 3, 5, 7, 18, 27, 6],
  },
  taurus: {
    ...
    luckyColor: ['ピンク', 'グリーン', 'クリーム', 'ラベンダー', 'ミントグリーン', 'サーモンピンク', 'ベージュ', 'ローズ'],
    luckyColor_en: ['Pink', 'Green', 'Cream', 'Lavender', 'Mint green', 'Salmon pink', 'Beige', 'Rose'],
    luckyItem: ['スイーツ', '観葉植物', 'ブランケット', 'ハンドクリーム', 'アロマキャンドル', 'フラワー', 'チョコレート', 'コスメポーチ'],
    luckyItem_en: ['Sweets', 'Houseplant', 'Blanket', 'Hand cream', 'Aroma candle', 'Flowers', 'Chocolate', 'Cosmetics pouch'],
    luckyNumber: [2, 6, 4, 8, 15, 24, 3, 9],
  },
  gemini: {
    ...
    luckyColor: ['イエロー', 'ライトブルー', 'シルバー', 'ミント', 'パステルイエロー', 'スカイブルー', 'ホワイト', 'マルチカラー'],
    luckyColor_en: ['Yellow', 'Light blue', 'Silver', 'Mint', 'Pastel yellow', 'Sky blue', 'White', 'Multicolor'],
    luckyItem: ['メモ帳', 'イヤホン', '文庫本', 'マスキングテープ', 'カラーペン', 'シール', 'おしゃれなカフェドリンク', 'ポーチ'],
    luckyItem_en: ['Notepad', 'Earphones', 'Paperback', 'Washi tape', 'Colored pen', 'Stickers', 'Trendy café drink', 'Pouch'],
    luckyNumber: [3, 5, 7, 11, 14, 2, 8, 20],
  },
  cancer: {
    ...
    luckyColor: ['ホワイト', 'シルバー', '水色', 'パールホワイト', 'ラベンダー', 'ライトグレー', 'ミルキーホワイト', 'ムーンストーンブルー'],
    luckyColor_en: ['White', 'Silver', 'Sky blue', 'Pearl white', 'Lavender', 'Light gray', 'Milky white', 'Moonstone blue'],
    luckyItem: ['手紙', '温かい飲み物', '月のモチーフ', 'フェイスマスク', 'ハーブティー', 'バスソルト', 'ルームスプレー', 'ぬいぐるみ'],
    luckyItem_en: ['Letter', 'Warm drink', 'Moon motif', 'Face mask', 'Herbal tea', 'Bath salt', 'Room spray', 'Plushie'],
    luckyNumber: [2, 7, 4, 6, 11, 22, 3, 9],
  },
  leo: {
    ...
    luckyColor: ['ゴールド', 'オレンジ', 'レッド', 'ローズゴールド', 'サンフラワーイエロー', 'シャンパン', 'コーラル', 'ブロンズ'],
    luckyColor_en: ['Gold', 'Orange', 'Red', 'Rose gold', 'Sunflower yellow', 'Champagne', 'Coral', 'Bronze'],
    luckyItem: ['アクセサリー', 'サングラス', 'ゴールドジュエリー', 'ハイライター', 'フラワーブーケ', 'リップグロス', 'ヘアアクセ', 'ネックレス'],
    luckyItem_en: ['Accessories', 'Sunglasses', 'Gold jewelry', 'Highlighter', 'Flower bouquet', 'Lip gloss', 'Hair accessory', 'Necklace'],
    luckyNumber: [1, 5, 9, 3, 19, 28, 6, 14],
  },
  virgo: {
    ...
    luckyColor: ['紺', 'グリーン', 'ベージュ', 'オフホワイト', 'ダスティローズ', 'セージグリーン', 'グレー', 'ナチュラルブラウン'],
    luckyColor_en: ['Navy', 'Green', 'Beige', 'Off-white', 'Dusty rose', 'Sage green', 'Gray', 'Natural brown'],
    luckyItem: ['手帳', '観葉植物', '整理グッズ', 'フェイスマスク', 'ハーブティー', 'ボディスクラブ', 'オーガニックコスメ', 'ノート'],
    luckyItem_en: ['Planner', 'Houseplant', 'Organizer', 'Face mask', 'Herbal tea', 'Body scrub', 'Organic cosmetics', 'Notebook'],
    luckyNumber: [6, 2, 8, 4, 12, 20, 5, 17],
  },
  libra: {
    ...
    luckyColor: ['ピンク', 'ライトブルー', 'ホワイト', 'ローズ', 'パステルパープル', 'シャンパン', 'ラベンダー', 'ミントグリーン'],
    luckyColor_en: ['Pink', 'Light blue', 'White', 'Rose', 'Pastel purple', 'Champagne', 'Lavender', 'Mint green'],
    luckyItem: ['鏡', 'アロマ', 'ネイル', 'リップ', 'フラワー', 'ヘアアクセ', 'おしゃれなカフェ', 'ピアス'],
    luckyItem_en: ['Mirror', 'Aroma', 'Nail color', 'Lipstick', 'Flowers', 'Hair accessory', 'Stylish café', 'Earrings'],
    luckyNumber: [6, 4, 2, 8, 15, 24, 9, 3],
  },
  scorpio: {
    ...
    luckyColor: ['深紅', '黒', 'パープル', 'バーガンディ', 'ディープワイン', 'ミッドナイトブルー', 'マルーン', 'チャコール'],
    luckyColor_en: ['Crimson', 'Black', 'Purple', 'Burgundy', 'Deep wine', 'Midnight blue', 'Maroon', 'Charcoal'],
    luckyItem: ['パワーストーン', '香水', 'ダークリップ', 'ムーンストーン', 'ミステリー小説', 'ブラックアクセサリー', '鍵モチーフ', 'アイライナー'],
    luckyItem_en: ['Power stone', 'Perfume', 'Dark lip color', 'Moonstone', 'Mystery novel', 'Black accessory', 'Key motif', 'Eyeliner'],
    luckyNumber: [8, 9, 11, 22, 4, 18, 13, 0],
  },
  sagittarius: {
    ...
    luckyColor: ['パープル', 'ロイヤルブルー', 'オレンジ', 'ターコイズ', 'コバルトブルー', 'サフランイエロー', 'エメラルド', 'ブライトブルー'],
    luckyColor_en: ['Purple', 'Royal blue', 'Orange', 'Turquoise', 'Cobalt blue', 'Saffron yellow', 'Emerald', 'Bright blue'],
    luckyItem: ['地図', 'スニーカー', 'トートバッグ', '旅行コスメポーチ', 'フォトブック', 'エスニックアクセ', '旅グッズ', '矢印モチーフ'],
    luckyItem_en: ['Map', 'Sneakers', 'Tote bag', 'Travel cosmetics pouch', 'Photo book', 'Ethnic accessory', 'Travel goods', 'Arrow motif'],
    luckyNumber: [3, 9, 7, 5, 21, 12, 14, 6],
  },
  capricorn: {
    ...
    luckyColor: ['ダークグリーン', 'ネイビー', 'ブラウン', 'チャコールグレー', 'カーキ', 'バーガンディ', 'オフホワイト', 'モスグリーン'],
    luckyColor_en: ['Dark green', 'Navy', 'Brown', 'Charcoal gray', 'Khaki', 'Burgundy', 'Off-white', 'Moss green'],
    luckyItem: ['時計', '革製品', 'ゴールドジュエリー', '手帳', '上質なコスメ', 'ボールペン', '山や石のモチーフ', 'ミネラルウォーター'],
    luckyItem_en: ['Watch', 'Leather goods', 'Gold jewelry', 'Planner', 'Premium cosmetics', 'Ballpoint pen', 'Mountain or stone motif', 'Mineral water'],
    luckyNumber: [4, 8, 10, 2, 22, 6, 13, 17],
  },
  aquarius: {
    ...
    luckyColor: ['水色', 'シルバー', 'ターコイズ', 'エレクトリックブルー', 'ラベンダー', 'アイスブルー', 'ホワイト', 'ネオンカラー'],
    luckyColor_en: ['Sky blue', 'Silver', 'Turquoise', 'Electric blue', 'Lavender', 'Ice blue', 'White', 'Neon color'],
    luckyItem: ['ガジェット', '星モチーフ', 'ユニークなピアス', 'インディーズコスメ', 'マスキングテープ', 'エコバッグ', '個性的なアクセ', '新しいアプリ'],
    luckyItem_en: ['Gadget', 'Star motif', 'Unique earrings', 'Indie cosmetics', 'Washi tape', 'Eco bag', 'Unique accessory', 'New app'],
    luckyNumber: [7, 11, 4, 2, 22, 17, 8, 3],
  },
  pisces: {
    ...
    luckyColor: ['シーグリーン', 'ラベンダー', 'ホワイト', 'アクアブルー', 'パールピンク', 'コーラル', 'ライラック', 'ミスティグレー'],
    luckyColor_en: ['Sea green', 'Lavender', 'White', 'Aqua blue', 'Pearl pink', 'Coral', 'Lilac', 'Misty gray'],
    luckyItem: ['海のモチーフ', 'アロマオイル', 'フェイスパック', 'バスグッズ', 'ドライフラワー', '真珠アクセ', 'ムーンライトキャンドル', '音楽'],
    luckyItem_en: ['Ocean motif', 'Aroma oil', 'Face pack', 'Bath goods', 'Dried flowers', 'Pearl accessory', 'Moonlight candle', 'Music'],
    luckyNumber: [7, 2, 12, 3, 9, 11, 6, 22],
  },
};
