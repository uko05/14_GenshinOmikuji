...
import { GACHA_DESIGNS } from './gachaBacks.js?v=4';
...
import { initFeed, submitFeedEntry, submitAchievementFeedEntry, refreshFeedLang, markMissionAchievedOnce } from './feed.js?v=30';
import { ACHIEVEMENT_GROUPS, ALL_ACHIEVEMENTS } from './achievements.js?v=4';
import { createListing, watchMyListings, isItemListed, renderCampaignBanner } from './auction.js?v=26';
...
const i18n = {
  ja: {
    ...
    feedTitle:       'みんなの結果（48時間以内）',
    hideFeedLabel:   '自分の占いを公開しない',
    statsUpLabel:       'うーこポイント',
    statsGachaLabel:    'ガチャを引く',
    gachaModalTitle:        'タロットスキンガチャ',
    gachaDrawBtn:            'ガチャをひく',
  ...
  en: {
    ...
    feedTitle:       "Everyone's Results (last 48h)",
    hideFeedLabel:   "Don't publish my fortune",
    statsUpLabel:       'Uko Points',
    statsGachaLabel:    'Gacha',
    gachaModalTitle:        'Tarot Skin Gacha',
    gachaDrawBtn:            'Draw',
